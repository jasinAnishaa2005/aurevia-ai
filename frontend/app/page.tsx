  ...
  >
    ...
    >
      ...
      <Link href="/calendar">CALENDAR TEST</Link>
    </div>
        ...
        <FeatureCard icon="📄" title="CV Analysis" />
        <FeatureCard icon="📊" title="Dashboard" />
        <FeatureCard icon="📅" title="Calendar" />
        <FeatureCard icon="✅" title="Tracker" />
        <FeatureCard icon="🎯" title="Fit Score" />
        <FeatureCard icon="🤖" title="AI Assistant" />
        <FeatureCard icon="💼" title="Job Hunter" />
        <FeatureCard icon="📝" title="Cover Letter" />
        <FeatureCard icon="🗺️" title="Roadmap" />
